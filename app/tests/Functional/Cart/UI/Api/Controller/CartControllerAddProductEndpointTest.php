 ...
 */
class CartControllerAddProductEndpointTest extends WebTestCase
{
    use ProductTestHelper;

    private KernelBrowser $httpClient;

    private string $uri = '/api/carts/%s/addproduct';
    ...
    public function testSuccessfulHttpRequest(): void
    {
        ...
        // When
       $this->client->request('PATCH', sprintf($this->uri, $uuidString), $data);
       $response = $this->client->getResponse();
        ...
        $this->assertEquals($responseData->carts[0]->products[0]->uuid, $newProduct->getUuid()->toString());
    }
