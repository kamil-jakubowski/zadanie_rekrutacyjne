 ...
 */
class CartControllerRemoveProductEndpointTest extends WebTestCase
{
    use ProductTestHelper;

    private KernelBrowser $httpClient;

    private string $uri = '/api/carts/%s/removeproduct';
    ...
    public function testSuccessfulHttpRequest(): void
    {
        ...
        $this->assertCount(0, $responseData->carts[0]->products);
    }
